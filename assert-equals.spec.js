...
describe('assertEquals', () => {
  ...
  describe('when expected and actual are different numbers', () => {
    it('throws an error', () => {
      expect(() => assertEquals(123, 456)).toThrow('Expected 123 but found 456');
    });
  });
  ...
  describe('when expected is NaN and actual is not NaN', () => {
    it('throws an error', () => {
      expect(() => assertEquals(NaN, 456)).toThrow('Expected NaN but found 456');
    });
  });
  ...
  describe('when expected and actual are different arrays containing strings', () => {
    it('throws an error', () => {
      expect(() => assertEquals(['abc', 'def'], ['abc', 'xyz'])).toThrow('Expected "def" but found "xyz" at index 1');
    });
  });
  ...
  describe('when expected and actual are different arrays', () => {
    it('throws an error', () => {
      expect(() => assertEquals([1, 2, 3], [1, 2, 4])).toThrow('Expected 3 but found 4 at index 2');
    });
  });

  describe('when expected and actual are arrays of different lengths', () => {
    it('throws an error', () => {
      expect(() => assertEquals([1, 2, 3], [1, 2])).toThrow('Expected array length 3 but found 2');
    });
  });

  describe('when expected and actual are arrays of different types', () => {
    it('throws an error', () => {
      expect(() => assertEquals([1, 2, 3], '123')).toThrow('Expected type object but found type string');
    });
  });
  ...
  describe('when expected and actual are different types', () => {
    it('throws an error', () => {
      expect(() => assertEquals(true, 1)).toThrow('Expected type boolean but found type number');
    });
  });
})